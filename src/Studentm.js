            ...
            <>
                ...
                <center >
                    ...
                    <Grid style={{ backgroundColor: "#f8f8f8", padding: "20px", borderRadius: "8px", width: "900px", marginTop: "20px", }}>
                        ...
                        <Typography style={{ color: "#000066", fontWeight: 600, fontSize: "18px", marginRight: "710px" }}>Parent's Details :</Typography>
                        <form style={{ paddingTop: "20px", paddingBottom: "20px" }}>
                            ...
                            <Grid style={{ display: "flex", justifyContent: "space-between", }}>
                                ...
                                <textarea id="message" placeholder="Address" required
                                    style={{ width: "880px", padding: "10px", borderRadius: "5px",borderColor: "1px solid #000066" }}></textarea>
                            </Grid>
